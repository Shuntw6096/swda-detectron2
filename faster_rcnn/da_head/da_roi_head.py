...
class DAStandardROIHeads(StandardROIHeads):
    @configurable
    def __init__(self,
        *,
        ...
        **kwargs,):
        ...
        super().__init__(box_in_features=box_in_features, box_pooler=box_pooler, box_head=box_head, box_predictor=box_predictor, \
            ...
            **kwargs,)
        self.regularization_feat = regularization_feat

    @classmethod
    def from_config(cls, cfg, input_shape):
        ret = super().from_config(cfg, input_shape) 
        ret["regularization_feat"] = cfg.MODEL.ROI_HEADS.REGULARIZATION_FEATURES
        return ret
    ...
    def _forward_box(self, features: Dict[str, torch.Tensor], proposals: List[Instances]):
        ...
        reg_feat = [features[f].view(1,-1) for f in self.regularization_feat]
    ...
    def _init_box_head(cls, cfg, input_shape):
        ...
        # concat with context regularization feature(global feat, local feat) 
        box_predictor = FastRCNNOutputLayers(cfg, ShapeSpec(channels=3 * box_head.output_shape.channels))
        return {
